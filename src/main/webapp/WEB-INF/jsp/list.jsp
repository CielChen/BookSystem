        	       ...
        	       <thead>
        	       		<tr>
        					...
        					<th>
                                ...
                                <a class="btn btn-info" id="returnToList" href="/booksystem/books/list" target="_blank">首页</a>
        					</th>
                            <th>
                                <button type="button" class="btn btn-info" id="addBook" style="float: right;" target="_blank">
                                	添加图书
                                </button>
                                <!--  
                                <a class="btn btn-info" id="manageBook" href="/booksystem/books/manageBook" target="_blank">管理图书</a>
                                -->
                            </th>
        				</tr>
        	       </thead>
            ...
            <table class="table table-hover">
                ...
                <c:forEach items="${list}" var="sk">
                    <tr>
                        ...
                        <td>${sk.name}</td>
                        <td>${sk.number}</td>
                        <td><a class="btn btn-info" href="/booksystem/books/${sk.bookId}/detail" target="_blank">详细</a></td>
                    </tr>
                </c:forEach>
                </tbody>
